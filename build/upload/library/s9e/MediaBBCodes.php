...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'spotify'=>array('Spotify','https://www.spotify.com/',array('music'=>1),'!(?:open|play)\\.spotify\\.com/(?P<id>(?:user/[-.\\w]+/)?(?:album|artist|playlist|track)(?:[:/][-.\\w]+)+)!',array('!(?:open|play)\\.spotify\\.com/(?P<id>(?:user/[-.\\w]+/)?(?:album|artist|playlist|track)(?:[:/][-.\\w]+)+)!')),
		...
		'tiktok'=>array('TikTok','https://www.tiktok.com',array('videos'=>1),"@tiktok\\.com/(?:v|i18n/share/video)/(?P<id>\\d+)@\n@(?P<id>)//vm\\.tiktok\\.com/.@",array('@tiktok\\.com/(?:v|i18n/share/video)/(?P<id>\\d+)@'),true,array(array('extract'=>array('@tiktok\\.com/v/(?P<id>\\d+)@','@musically://musical\\?id=(?P<id>\\d+)@'),'match'=>array('@//vm\\.tiktok\\.com/.@'))),'<span data-s9e-mediaembed="tiktok" style="display:inline-block;width:100%;max-width:340px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:205.882353%"><iframe allowfullscreen="" scrolling="no" src="//www.tiktok.com/embed/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></span></span>'),
