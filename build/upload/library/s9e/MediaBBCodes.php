...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'googledrive'=>array('Google Drive','https://drive.google.com',array('documents'=>1,'images'=>1,'videos'=>1),'!drive\\.google\\.com/file/d/(?\'id\'[-\\w]+)!',array('!drive\\.google\\.com/file/d/(?\'id\'[-\\w]+)!'),7=>'<iframe width="640" height="480" src="//drive.google.com/file/d/{$id}/preview" allowfullscreen="" frameborder="0" scrolling="no" data-s9e=""></iframe>'),
		...
		'imdb'=>array('IMDb','http://www.imdb.com/',array('movies'=>1),'!imdb\\.com/video/\\w+/vi(?\'id\'\\d+)!',array('!imdb\\.com/video/\\w+/vi(?\'id\'\\d+)!'),7=>'<iframe width="560" height="315" src="//www.imdb.com/video/imdb/vi{$id}/imdb/embed?autoplay=false&amp;width=560" allowfullscreen="" frameborder="0" scrolling="no" data-s9e=""></iframe>'),
		...
		'instagram'=>array('Instagram','http://instagram.com/',array('social'=>1),'!instagram\\.com/p/(?\'id\'[-\\w]+)!',array('!instagram\\.com/p/(?\'id\'[-\\w]+)!'),7=>'<iframe width="612" height="710" src="//instagram.com/p/{$id}/embed/" allowfullscreen="" frameborder="0" scrolling="no" data-s9e=""></iframe>'),
	...
	*/
	...
	public static function renderAudiomack($vars)
	{
		...
		$html='';if($vars['mode']==='album')$html.='<iframe width="100%" height="340" src="//www.audiomack.com/embed4-album/';else$html.='<iframe width="100%" height="110" src="//www.audiomack.com/embed4/';$html.=htmlspecialchars($vars['id'],2).'" style="max-width:900px" allowfullscreen="" frameborder="0" scrolling="no" data-s9e=""></iframe>';
	...
	public static function renderSoundcloud($vars)
	{
		...
		$html='';if(isset($vars['playlist_id']))$html.='<iframe width="100%" height="450" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/'.htmlspecialchars($vars['playlist_id'],2);elseif(isset($vars['track_id']))$html.='<iframe width="100%" height="166" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/'.htmlspecialchars($vars['track_id'],2);elseif((strpos($vars['id'],'://')===false))$html.='<iframe width="100%" height="166" src="https://w.soundcloud.com/player/?url=https%3A//soundcloud.com/'.htmlspecialchars($vars['id'],2);else$html.='<iframe width="100%" height="166" src="https://w.soundcloud.com/player/?url='.htmlspecialchars($vars['id'],2);$html.='" style="max-width:900px" allowfullscreen="" frameborder="0" scrolling="no" data-s9e=""></iframe>';
	...
	public static function renderUstream($vars)
	{
		...
		$html='<iframe width="560" height="315" allowfullscreen="" frameborder="0" scrolling="no" data-s9e="" src="//www.ustream.tv/embed/';if(isset($vars['vid']))$html.='recorded/'.htmlspecialchars($vars['vid'],2);else$html.=htmlspecialchars($vars['cid'],2);$html.='?html5ui"></iframe>';
