...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'bbcnews'=>array('BBC News','http://www.bbc.com/news/video_and_audio/',array('news'=>1),'!(?P<id>)bbc\\.com/news/\\w+!',array(),true,array(array('extract'=>array('!bbc\\.com\\\\/news\\\\/(?P<id>[-\\w]+)\\\\/embed!'),'match'=>array('!bbc\\.com/news/\\w+!')))),
		...
		'pinterest'=>array('Pinterest','https://www.pinterest.com/',array('social'=>1),"@(?=.*?[./]pinterest\\.com[:/]).*?pinterest.com/pin/(?P<id>\\d+)@\n@(?=.*?[./]pinterest\\.com[:/]).*?pinterest.com/(?!pin/)(?P<id>[-\\w]+/[-\\w]+)@",array('@(?=.*?[./]pinterest\\.com[:/]).*?pinterest.com/pin/(?P<id>\\d+)@','@(?=.*?[./]pinterest\\.com[:/]).*?pinterest.com/(?!pin/)(?P<id>[-\\w]+/[-\\w]+)@')),
		...
		'twitch'=>array('Twitch','http://www.twitch.tv/',array('gaming'=>1),"#(?P<id>)twitch\\.tv/videos/(?P<video_id>\\d+)?#\n#(?P<id>)twitch\\.tv/(?!videos/)(?P<channel>\\w+)(?:/b/(?P<archive_id>\\d+)|/c/(?P<chapter_id>\\d+)|/v/(?P<video_id>\\d+))?#\n#(?P<id>)(?=.*?[./]twitch\\.tv[:/]).*?t=(?P<t>(?:(?:\\d+h)?\\d+m)?\\d+s)#\n#(?P<id>)clips\\.twitch\\.tv/(?P<channel>\\w+)/(?P<clip_id>\\w+)#",array('#twitch\\.tv/videos/(?P<video_id>\\d+)?#','#twitch\\.tv/(?!videos/)(?P<channel>\\w+)(?:/b/(?P<archive_id>\\d+)|/c/(?P<chapter_id>\\d+)|/v/(?P<video_id>\\d+))?#','#(?=.*?[./]twitch\\.tv[:/]).*?t=(?P<t>(?:(?:\\d+h)?\\d+m)?\\d+s)#','#clips\\.twitch\\.tv/(?P<channel>\\w+)/(?P<clip_id>\\w+)#'),true),
		...
		'youku'=>array('Youku','http://www.youku.com/',array('.cn'=>1),'!youku\\.com/v_show/id_(?P<id>\\w+)!',array('!youku\\.com/v_show/id_(?P<id>\\w+)!'),7=>'<div data-s9e-mediaembed="youku" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:62.5%;padding-bottom:calc(56.25% + 40px)"><object data="https://players.youku.com/player.php/sid/{$id}/v.swf" style="height:100%;left:0;position:absolute;width:100%" type="application/x-shockwave-flash" typemustmatch=""><param name="allowfullscreen" value="true"/></object></div></div>'),
		'youtube'=>array('YouTube','http://www.youtube.com/',array('videos'=>1),"!youtube\\.com/(?:watch.*?v=|v/|attribution_link.*?v%3D)(?P<id>[-\\w]+)!\n!youtu\\.be/(?P<id>[-\\w]+)!\n!(?P<id>)(?=.*?[./]youtu(?>\\.be|be\\.com)[:/]).*?[#&?]t=(?:(?:(?P<h>\\d+)h)?(?P<m>\\d+)m(?P<s>\\d+)|(?P<t>\\d+))!\n!(?P<id>)(?=.*?[./]youtu(?>\\.be|be\\.com)[:/]).*?&list=(?P<list>[-\\w]+)!\n!(?P<id>)(?=.*?[./]youtu(?>\\.be|be\\.com)[:/]).*?/shared\\?ci=!",array('!youtube\\.com/(?:watch.*?v=|v/|attribution_link.*?v%3D)(?P<id>[-\\w]+)!','!youtu\\.be/(?P<id>[-\\w]+)!','!(?=.*?[./]youtu(?>\\.be|be\\.com)[:/]).*?[#&?]t=(?:(?:(?P<h>\\d+)h)?(?P<m>\\d+)m(?P<s>\\d+)|(?P<t>\\d+))!','!(?=.*?[./]youtu(?>\\.be|be\\.com)[:/]).*?&list=(?P<list>[-\\w]+)!'),true,array(array('extract'=>array('!/vi/(?P<id>[-\\w]+)!'),'match'=>array('!/shared\\?ci=!')))),
