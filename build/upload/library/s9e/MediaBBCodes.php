...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'comedycentral'=>array('Comedy Central','http://www.comedycentral.com/funny-videos',array('entertainment'=>1),'!(?\'id\')c(?:c|omedycentral)\\.com/video-clips/!',array(),true,array(array('extract'=>array('!(?\'id\'mgid:arc:video:[.\\w]+:[-\\w]+)!'),'match'=>array('!c(?:c|omedycentral)\\.com/video-clips/!'))),'<div data-s9e-mediaembed="comedycentral" style="display:inline-block;width:100%;max-width:512px"><div style="position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//media.mtvnservices.com/embed/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'gametrailers'=>array('GameTrailers','http://www.gametrailers.com/',array('gaming'=>1),'!(?\'id\')gametrailers\\.com/(?:full-episode|review|video)s/!',array(),true,array(array('extract'=>array('!(?\'id\'mgid:arc:(?:episode|video):gametrailers\\.com:[-\\w]+)!'),'match'=>array('!gametrailers\\.com/(?:full-episode|review|video)s/!'))),'<div data-s9e-mediaembed="gametrailers" style="display:inline-block;width:100%;max-width:512px"><div style="position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//media.mtvnservices.com/embed/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'soundcloud'=>array('SoundCloud','https://soundcloud.com/',array('music'=>1),"@(?'id'https?://(?:api\\.)?soundcloud\\.com/(?!pages/)[-/\\w]+/[-/\\w]+|^[^/]+/[^/]+$)@\n@(?'id')(?=.*?[./]soundcloud\\.com[:/]).*?api.soundcloud.com/playlists/(?'playlist_id'\\d+)@\n@(?'id')(?=.*?[./]soundcloud\\.com[:/]).*?api.soundcloud.com/tracks/(?'track_id'\\d+)@",array('@(?\'id\'https?://(?:api\\.)?soundcloud\\.com/(?!pages/)[-/\\w]+/[-/\\w]+|^[^/]+/[^/]+$)@','@(?=.*?[./]soundcloud\\.com[:/]).*?api.soundcloud.com/playlists/(?\'playlist_id\'\\d+)@','@(?=.*?[./]soundcloud\\.com[:/]).*?api.soundcloud.com/tracks/(?\'track_id\'\\d+)@'),true),
