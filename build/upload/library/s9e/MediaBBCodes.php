...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'scribd'=>array('Scribd','http://www.scribd.com/',array('documents'=>1,'presentations'=>1),'!scribd\\.com/(?:mobile/)?(?:doc(?:ument)?|presentation)/(?P<id>\\d+)!',array('!scribd\\.com/(?:mobile/)?(?:doc(?:ument)?|presentation)/(?P<id>\\d+)!'),7=>'<iframe data-s9e-mediaembed="scribd" allowfullscreen="" scrolling="no" src="https://www.scribd.com/embeds/{$id}/content?view_mode=scroll&amp;show_recommendations=false" style="border:0;height:500px;resize:vertical;width:100%"></iframe>'),
