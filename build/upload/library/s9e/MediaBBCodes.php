...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'facebook'=>array('Facebook','http://www.facebook.com/',array('social'=>1),'@(?=.*?[./]w(?>eb|ww)\\.facebook\\.com[:/]).*?facebook\\.com/(?:[/\\w]+/permalink|(?!pages/|groups/).*?)(?:/|fbid=|\\?v=)(?\'id\'\\d+)(?=$|[/?&#])@',array('@(?=.*?[./]w(?>eb|ww)\\.facebook\\.com[:/]).*?facebook\\.com/(?:[/\\w]+/permalink|(?!pages/|groups/).*?)(?:/|fbid=|\\?v=)(?\'id\'\\d+)(?=$|[/?&#])@'),7=>'<iframe data-s9e-mediaembed="facebook" allowfullscreen="" onload="var a=Math.random();window.addEventListener(\'message\',function(b){if(b.data.id==a)style.height=b.data.height+\'px\'});contentWindow.postMessage(\'s9e:\'+a,src.substr(0,src.indexOf(\'/\',8)))" scrolling="no" src="//s9e.github.io/iframe/facebook.min.html#{$id}" style="border:0;height:360px;max-width:640px;width:100%"></iframe>'),
