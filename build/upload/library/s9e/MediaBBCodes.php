...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'soundcloud'=>array('SoundCloud','https://soundcloud.com/',array('music'=>1),"@(?P<id>https?://(?:api\\.)?soundcloud\\.com/(?!pages/)[-/\\w]+/[-/\\w]+|^[^/]+/[^/]+$)@\n@(?P<id>)(?=.*?[./]soundcloud\\.com[:/]).*?api.soundcloud.com/playlists/(?P<playlist_id>\\d+)@\n@(?P<id>)(?=.*?[./]soundcloud\\.com[:/]).*?api.soundcloud.com/tracks/(?P<track_id>\\d+)(?:\\?secret_token=(?P<secret_token>[-\\w]+))?@\n@(?P<id>)soundcloud\\.com/(?!playlists|tracks)[-\\w]+/[-\\w]+/(?=s-)(?P<secret_token>[-\\w]+)@\n@(?P<id>)soundcloud\\.com/(?!playlists|tracks)[-\\w]+/[-\\w]+/s-@\n@(?P<id>)soundcloud\\.com/\\w+/sets/@",array('@(?P<id>https?://(?:api\\.)?soundcloud\\.com/(?!pages/)[-/\\w]+/[-/\\w]+|^[^/]+/[^/]+$)@','@(?=.*?[./]soundcloud\\.com[:/]).*?api.soundcloud.com/playlists/(?P<playlist_id>\\d+)@','@(?=.*?[./]soundcloud\\.com[:/]).*?api.soundcloud.com/tracks/(?P<track_id>\\d+)(?:\\?secret_token=(?P<secret_token>[-\\w]+))?@','@soundcloud\\.com/(?!playlists|tracks)[-\\w]+/[-\\w]+/(?=s-)(?P<secret_token>[-\\w]+)@'),true,array(array('extract'=>array('@soundcloud:tracks:(?P<track_id>\\d+)@'),'match'=>array('@soundcloud\\.com/(?!playlists|tracks)[-\\w]+/[-\\w]+/s-@')),array('extract'=>array('@soundcloud://playlists:(?P<playlist_id>\\d+)@'),'match'=>array('@soundcloud\\.com/\\w+/sets/@')))),
	...
	*/
	...
	public static function renderFacebook($vars)
	{
		...
		$html='';if($vars['type']==='video')$html.='<div data-s9e-mediaembed="facebook" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Fuser%2Fvideos%2F'.htmlspecialchars($vars['id'],2).'%2F%3Ftype%3D3" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>';else$html.='<iframe data-s9e-mediaembed="facebook" allowfullscreen="" onload="var a=Math.random();window.addEventListener(\'message\',function(b){if(b.data.id==a)style.height=b.data.height+\'px\'});contentWindow.postMessage(\'s9e:\'+a,\'https://s9e.github.io\')" scrolling="no" src="https://s9e.github.io/iframe/facebook.min.html#'.htmlspecialchars($vars['id'],2).'" style="border:0;height:360px;max-width:640px;width:100%"></iframe>';
