...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'facebook'=>array('Facebook','http://www.facebook.com/',array('social'=>1),'@/(?!(?:apps|developers|graph)\\.)[-\\w.]*facebook\\.com/(?:[/\\w]+/permalink|(?!pages/|groups/).*?)(?:/|fbid=|\\?v=)(?\'id\'\\d+)(?=$|[/?&#])@',array('@/(?!(?:apps|developers|graph)\\.)[-\\w.]*facebook\\.com/(?:[/\\w]+/permalink|(?!pages/|groups/).*?)(?:/|fbid=|\\?v=)(?\'id\'\\d+)(?=$|[/?&#])@'),7=>'<iframe data-s9e-mediaembed="facebook" allowfullscreen="" onload="var a=Math.random();window.addEventListener(\'message\',function(b){if(b.data.id==a)style.height=b.data.height+\'px\'});contentWindow.postMessage(\'s9e:\'+a,\'https://s9e.github.io\')" scrolling="no" src="https://s9e.github.io/iframe/facebook.min.html#{$id}" style="border:0;height:360px;max-width:640px;width:100%"></iframe>'),
		...
		'gist'=>array('GitHub Gist (via custom iframe)','https://gist.github.com/',array('misc'=>1),'!gist\\.github\\.com/(?\'id\'(?:\\w+/)?[\\da-f]+(?:/[\\da-f]+)?)!',array('!gist\\.github\\.com/(?\'id\'(?:\\w+/)?[\\da-f]+(?:/[\\da-f]+)?)!'),7=>'<iframe data-s9e-mediaembed="gist" allowfullscreen="" onload="var a=Math.random();window.addEventListener(\'message\',function(b){if(b.data.id==a)style.height=b.data.height+\'px\'});contentWindow.postMessage(\'s9e:\'+a,\'https://s9e.github.io\')" scrolling="no" src="https://s9e.github.io/iframe/gist.min.html#{$id}" style="border:0;height:180px;width:100%"></iframe>'),
		...
		'instagram'=>array('Instagram','http://instagram.com/',array('social'=>1),'!instagram\\.com/p/(?\'id\'[-\\w]+)!',array('!instagram\\.com/p/(?\'id\'[-\\w]+)!'),7=>'<iframe data-s9e-mediaembed="instagram" allowfullscreen="" onload="var a=Math.random();window.addEventListener(\'message\',function(b){if(b.data.id==a)style.height=b.data.height+\'px\'});contentWindow.postMessage(\'s9e:\'+a,\'https://s9e.github.io\')" scrolling="no" src="https://s9e.github.io/iframe/instagram.min.html#{$id}" style="border:0;height:640px;max-width:640px;width:100%"></iframe>'),
		...
		'rdio'=>array('Rdio','http://www.rdio.com/',array('music'=>1),"!rd\\.io/./(?'id'\\w+)!\n!(?'id')rdio\\.com/.*?(?:playlist|track)!",array('!rd\\.io/./(?\'id\'\\w+)!'),true,array(array('extract'=>array('!rd\\.io/./(?\'id\'\\w+)!'),'match'=>array('!rdio\\.com/.*?(?:playlist|track)!'),'url'=>'http://www.rdio.com/api/oembed/?url={@url}')),'<div data-s9e-mediaembed="rdio" style="display:inline-block;width:100%;max-width:400px"><div style="overflow:hidden;position:relative;padding-bottom:100%"><iframe allowfullscreen="" scrolling="no" src="https://rd.io/i/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'twitter'=>array('Twitter','https://twitter.com/',array('social'=>1),'@twitter\\.com/(?:#!/)?\\w+/status(?:es)?/(?\'id\'\\d+)@',array('@twitter\\.com/(?:#!/)?\\w+/status(?:es)?/(?\'id\'\\d+)@'),7=>'<iframe data-s9e-mediaembed="twitter" allowfullscreen="" onload="var a=Math.random();window.addEventListener(\'message\',function(b){if(b.data.id==a)style.height=b.data.height+\'px\'});contentWindow.postMessage(\'s9e:\'+a,\'https://s9e.github.io\')" scrolling="no" src="https://s9e.github.io/iframe/twitter.min.html#{$id}" style="border:0;height:186px;max-width:500px;width:100%"></iframe>'),
	...
	*/
	...
	public static function renderTwitch($vars)
	{
		...
		$html='<div data-s9e-mediaembed="twitch" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:60.9375%;padding-bottom:calc(56.25% + 30px)"><iframe allowfullscreen="" scrolling="no" style="border:0;height:100%;left:0;position:absolute;width:100%" src="https://s9e.github.io/iframe/twitch.min.html#channel='.htmlspecialchars($vars['channel'],2);if(isset($vars['archive_id']))$html.='&amp;videoId=a'.htmlspecialchars($vars['archive_id'],2);elseif(isset($vars['chapter_id']))$html.='&amp;videoId=c'.htmlspecialchars($vars['chapter_id'],2);elseif(isset($vars['video_id']))$html.='&amp;videoId=v'.htmlspecialchars($vars['video_id'],2);$html.='"></iframe></div></div>';
