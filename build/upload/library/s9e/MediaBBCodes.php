...
class s9e_MediaBBCodes
{
	...
	*/
	...
	public static function renderTwitch($vars)
	{
		...
		$html='<object type="application/x-shockwave-flash" typemustmatch="" width="620" height="378" data="//www.twitch.tv/widgets/';if(isset($vars['archive_id'])||isset($vars['chapter_id'])||isset($vars['video_id']))$html.='arch';else$html.='l';$html.='ive_embed_player.swf"><param name="allowfullscreen" value="true"><param name="flashvars" value="channel='.htmlspecialchars($vars['channel'],2);if(isset($vars['archive_id']))$html.='&amp;archive_id='.htmlspecialchars($vars['archive_id'],2);if(isset($vars['chapter_id']))$html.='&amp;chapter_id='.htmlspecialchars($vars['chapter_id'],2);if(isset($vars['video_id']))$html.='&amp;videoId=v'.htmlspecialchars($vars['video_id'],2);$html.='&amp;auto_play=false"><embed type="application/x-shockwave-flash" width="620" height="378" allowfullscreen="" src="//www.twitch.tv/widgets/';if(isset($vars['archive_id'])||isset($vars['chapter_id'])||isset($vars['video_id']))$html.='arch';else$html.='l';$html.='ive_embed_player.swf" flashvars="channel='.htmlspecialchars($vars['channel'],2);if(isset($vars['archive_id']))$html.='&amp;archive_id='.htmlspecialchars($vars['archive_id'],2);if(isset($vars['chapter_id']))$html.='&amp;chapter_id='.htmlspecialchars($vars['chapter_id'],2);if(isset($vars['video_id']))$html.='&amp;videoId=v'.htmlspecialchars($vars['video_id'],2);$html.='&amp;auto_play=false"></object>';
