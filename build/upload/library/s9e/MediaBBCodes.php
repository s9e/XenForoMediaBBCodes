...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'imgur'=>array('Imgur','http://imgur.com/',array('images'=>1),'@imgur\\.com/(?![rt]/|user/)(?P<id>(?:\\w+/)?\\w{5,7})@',array('@imgur\\.com/(?![rt]/|user/)(?P<id>(?:\\w+/)?\\w{5,7})@')),
		...
		'vevo'=>array('Vevo','https://vevo.com/',array('music'=>1),'!vevo\\.com/watch/([-/\\w]+/)?(?P<id>[A-Z0-9]+)!',array('!vevo\\.com/watch/([-/\\w]+/)?(?P<id>[A-Z0-9]+)!'),7=>'<span data-s9e-mediaembed="vevo" style="display:inline-block;width:100%;max-width:640px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="https://embed.vevo.com/?isrc={$id}&amp;autoplay=0&amp;siteSection=html5_desktop_embedded_twitter&amp;partnerId=E6513315-1700-46BA-81CB-6CC0C8C10E8E" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></span></span>'),
