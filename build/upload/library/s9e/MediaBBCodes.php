...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'gfycat'=>array('Gfycat','http://gfycat.com/',array('images'=>1),'!gfycat\\.com/(?\'id\'\\w+)!',array('!gfycat\\.com/(?\'id\'\\w+)!'),true,array(array('extract'=>array('!property="og:image:height"\\s*content="(?\'height\'\\d+)!','!property="og:image:width"\\s*content="(?\'width\'\\d+)!'),'match'=>array('//'),'url'=>'http://gfycat.com/{@id}'))),
