...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'anchor'=>array('Anchor','https://anchor.fm/',array('podcasts'=>1),'@(?=.*?[./]anchor\\.fm[:/]).*?anchor.fm/[-\\w]+/episodes/(?:[-\\w]+-)(?P<id>\\w+)(?![-\\w])@',array('@(?=.*?[./]anchor\\.fm[:/]).*?anchor.fm/[-\\w]+/episodes/(?:[-\\w]+-)(?P<id>\\w+)(?![-\\w])@'),7=>'<iframe data-s9e-mediaembed="anchor" allowfullscreen="" loading="lazy" scrolling="no" src="//anchor.fm/embed/episodes/x-{$id}" style="border:0;height:102px;max-width:700px;width:100%"></iframe>'),
		...
		'facebook'=>array('Facebook','https://www.facebook.com/',array('social'=>1),"@/(?!(?:apps|developers|graph)\\.)[-\\w.]*facebook\\.com/(?:[/\\w]+/permalink|(?!marketplace/|pages/|groups/).*?)(?:/|fbid=|\\?v=)(?P<id>\\d+)(?=$|[/?&#])@\n@(?P<id>)facebook\\.com/(?P<user>[.\\w]+)/(?=(?:post|video)s?/)(?P<type>[pv])@\n@(?P<id>)facebook\\.com/video/(?=post|video)(?P<type>[pv])@\n@(?P<id>)facebook\\.com/watch/\\?(?P<type>[pv])=@",array('@/(?!(?:apps|developers|graph)\\.)[-\\w.]*facebook\\.com/(?:[/\\w]+/permalink|(?!marketplace/|pages/|groups/).*?)(?:/|fbid=|\\?v=)(?P<id>\\d+)(?=$|[/?&#])@','@facebook\\.com/(?P<user>[.\\w]+)/(?=(?:post|video)s?/)(?P<type>[pv])@','@facebook\\.com/video/(?=post|video)(?P<type>[pv])@','@facebook\\.com/watch/\\?(?P<type>[pv])=@'),true),
		...
		'gist'=>array('GitHub Gist','https://gist.github.com/',array('programming'=>1),'!gist\\.github\\.com/(?P<id>(?:\\w+/)?[\\da-f]+(?:/[\\da-f]+)?)!',array('!gist\\.github\\.com/(?P<id>(?:\\w+/)?[\\da-f]+(?:/[\\da-f]+)?)!')),
		...
		'medium'=>array('Medium','https://medium.com/',array('blogging'=>1),'!medium\\.com/(?:s/)?[^/]*/(?:[-\\w]+-)?(?P<id>[\\da-f]+)!',array('!medium\\.com/(?:s/)?[^/]*/(?:[-\\w]+-)?(?P<id>[\\da-f]+)!'),7=>'<iframe data-s9e-mediaembed="medium" allowfullscreen="" loading="lazy" onload="var c=new MessageChannel;c.port1.onmessage=function(e){style.height=e.data+\'px\'};contentWindow.postMessage(\'s9e:init\',\'https://s9e.github.io\',[c.port2])" scrolling="no" src="https://s9e.github.io/iframe/2/medium.min.html#{$id}" style="border:0;height:316px;max-width:900px;width:100%"></iframe>'),
		'megaphone'=>array('Megaphone','https://megaphone.fm/',array('podcasts'=>1),"@megaphone\\.fm/.*?\\?(?:e|selected)=(?P<id>\\w+)@\n@(?:dcs|player|traffic)\\.megaphone\\.fm/(?P<id>\\w+)@\n@megaphone\\.link/(?P<id>\\w+)@",array('@megaphone\\.fm/.*?\\?(?:e|selected)=(?P<id>\\w+)@','@(?:dcs|player|traffic)\\.megaphone\\.fm/(?P<id>\\w+)@','@megaphone\\.link/(?P<id>\\w+)@'),7=>'<iframe data-s9e-mediaembed="megaphone" allowfullscreen="" loading="lazy" scrolling="no" src="https://player.megaphone.fm/{$id}" style="border:0;height:200px;max-width:900px;width:100%"></iframe>'),
		...
		'wistia'=>array('Wistia','https://wistia.com/',array('videos'=>1),'!(?=.*?[./]wistia\\.com[:/]).*?wistia.com/medias/(?P<id>\\w+)!',array('!(?=.*?[./]wistia\\.com[:/]).*?wistia.com/medias/(?P<id>\\w+)!'),7=>'<span data-s9e-mediaembed="wistia" style="display:inline-block;width:100%;max-width:640px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" loading="lazy" scrolling="no" src="https://fast.wistia.net/embed/iframe/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></span></span>'),
		'wshh'=>array('WorldStarHipHop','https://www.worldstarhiphop.com/',array('videos'=>1),"!worldstarhiphop\\.com/featured/(?P<id>\\d+)!\n!(?P<id>)worldstarhiphop\\.com/(?:\\w+/)?video\\.php\\?v=\\w+!",array('!worldstarhiphop\\.com/featured/(?P<id>\\d+)!'),true,array(array('extract'=>array('!v: ?"?(?P<id>\\d+)!'),'match'=>array('!worldstarhiphop\\.com/(?:\\w+/)?video\\.php\\?v=\\w+!'))),'<span data-s9e-mediaembed="wshh" style="display:inline-block;width:100%;max-width:640px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" loading="lazy" scrolling="no" src="//www.worldstarhiphop.com/embed/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></span></span>'),
	...
	*/
	...
	public static function renderMixer($vars)
	{
		...
		$html='<span data-s9e-mediaembed="mixer" style="display:inline-block;width:100%;max-width:640px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" loading="lazy" scrolling="no" style="border:0;height:100%;left:0;position:absolute;width:100%" src="https://mixer.com/embed/player/'.htmlspecialchars($vars['channel'],2);if(isset($vars['vod']))$html.='?vod='.htmlspecialchars($vars['vod'],2);$html.='"></iframe></span></span>';
	...
	public static function renderSoundcloud($vars)
	{
		...
		$html='<iframe data-s9e-mediaembed="soundcloud" allowfullscreen="" loading="lazy" scrolling="no" src="https://w.soundcloud.com/player/?url=';if(isset($vars['playlist_id']))$html.='https%3A//api.soundcloud.com/playlists/'.htmlspecialchars($vars['playlist_id'],2);elseif(isset($vars['track_id']))$html.='https%3A//api.soundcloud.com/tracks/'.htmlspecialchars($vars['track_id'],2).'&amp;secret_token='.htmlspecialchars($vars['secret_token'],2);else{if((strpos($vars['id'],'://')===false))$html.='https%3A//soundcloud.com/';$html.=htmlspecialchars($vars['id'],2);}$html.='" style="border:0;height:';if(isset($vars['playlist_id'])||(strpos($vars['id'],'/sets/')!==false))$html.='450';else$html.='166';$html.='px;max-width:900px;width:100%"></iframe>';
	...
	public static function renderSpotify($vars)
	{
		...
		$html='';if((strpos($vars['id'],'episode/')===0)||(strpos($vars['id'],'show/')===0))$html.='<iframe data-s9e-mediaembed="spotify" allow="encrypted-media" allowfullscreen="" loading="lazy" scrolling="no" src="https://open.spotify.com/embed/'.htmlspecialchars($vars['id'],2).'" style="border:0;height:152px;max-width:900px;width:100%"></iframe>';else$html.='<span data-s9e-mediaembed="spotify" style="display:inline-block;width:100%;max-width:320px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:125%;padding-bottom:calc(100% + 80px)"><iframe allow="encrypted-media" allowfullscreen="" loading="lazy" scrolling="no" src="https://open.spotify.com/embed/'.htmlspecialchars(strtr($vars['id'],':','/').$vars['path'],2).'" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></span></span>';
	...
	public static function renderSpreaker($vars)
	{
		...
		$html='<iframe data-s9e-mediaembed="spreaker" allowfullscreen="" loading="lazy" scrolling="no" src="https://widget.spreaker.com/player?episode_id='.htmlspecialchars($vars['episode_id'],2).'&amp;show_id='.htmlspecialchars($vars['show_id'],2).'" style="border:0;height:'.htmlspecialchars(400-200*isset($vars['episode_id']),2).'px;max-width:900px;width:100%"></iframe>';
	...
	public static function renderStitcher($vars)
	{
		...
		$html='<iframe data-s9e-mediaembed="stitcher" allowfullscreen="" loading="lazy" scrolling="no" src="//app.stitcher.com/splayer/f/'.htmlspecialchars($vars['fid'],2).'/'.htmlspecialchars($vars['eid'],2).'" style="border:0;height:150px;max-width:900px;width:100%"></iframe>';
	...
	public static function renderVimeo($vars)
	{
		...
		$html='<span data-s9e-mediaembed="vimeo" style="display:inline-block;width:100%;max-width:640px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" loading="lazy" scrolling="no" style="border:0;height:100%;left:0;position:absolute;width:100%" src="//player.vimeo.com/video/'.htmlspecialchars($vars['id'],2);if(isset($vars['t']))$html.='#t='.htmlspecialchars($vars['t'],2);$html.='"></iframe></span></span>';
