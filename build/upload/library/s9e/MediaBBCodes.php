...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'imgur'=>array('Imgur','http://imgur.com/',array('images'=>1),"@imgur\\.com/(?P<id>a/\\w+)@\n@i\\.imgur\\.com/(?P<id>\\w{5,7})[lms]?\\.@\n@imgur\\.com/(?P<id>\\w+)(?![\\w./])@\n@imgur\\.com/gallery/(?P<id>\\w+)@\n@(?P<id>)imgur\\.com/(?![art]/|user/)(?P<path>(?:gallery/)?\\w+)(?![\\w.])@",array('@imgur\\.com/(?P<id>a/\\w+)@','@i\\.imgur\\.com/(?P<id>\\w{5,7})[lms]?\\.@','@imgur\\.com/(?P<id>\\w+)(?![\\w./])@','@imgur\\.com/gallery/(?P<id>\\w+)@'),true,array(array('extract'=>array('@data-id="(?P<id>[\\w/]+)"@'),'match'=>array('@imgur\\.com/(?![art]/|user/)(?P<path>(?:gallery/)?\\w+)(?![\\w.])@'),'url'=>'https://api.imgur.com/oembed.xml?url=http://imgur.com/{@path}'))),
