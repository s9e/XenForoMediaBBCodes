...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'vidme'=>array('vidme','https://vid.me',array('videos'=>1),'((?P<id>)vid\\.me/)',array(),true,array(array('extract'=>array('!maxwidth=(?P<width>\\d+).*?maxheight=(?P<height>\\d+)!','!vid\\.me/e/(?P<id>\\w+)!'),'match'=>array('//')))),
