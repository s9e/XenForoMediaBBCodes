...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'blab'=>array('Blab','https://blab.im/',array('social'=>1),'#blab\\.im/(?!about$|live$|replay$|scheduled$|search\\?)(?\'id\'[-\\w]+)#',array('#blab\\.im/(?!about$|live$|replay$|scheduled$|search\\?)(?\'id\'[-\\w]+)#'),7=>'<div data-s9e-mediaembed="blab" style="display:inline-block;width:100%;max-width:400px"><div style="overflow:hidden;position:relative;padding-bottom:100%"><iframe allowfullscreen="" scrolling="no" src="https://blab.im/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'indiegogo'=>array('Indiegogo','http://www.indiegogo.com/',array('fundraising'=>1),'!indiegogo\\.com/projects/(?\'id\'[-\\w]+)!',array('!indiegogo\\.com/projects/(?\'id\'[-\\w]+)!'),7=>'<div data-s9e-mediaembed="indiegogo" style="display:inline-block;width:100%;max-width:222px"><div style="overflow:hidden;position:relative;padding-bottom:200.45045045045%"><iframe allowfullscreen="" scrolling="no" src="//www.indiegogo.com/project/{$id}/embedded" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
