...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'hudl'=>array('Hudl','http://www.hudl.com/',array('sports'=>1),"!(?P<id>)hudl\\.com/athlete/(?P<athlete>\\d+)/highlights/(?P<highlight>[\\da-f]+)!\n!(?P<id>)hudl\\.com/video/\\d+/(?P<athlete>\\d+)/(?P<highlight>[\\da-f]+)!\n!(?P<id>)hudl\\.com/v/!",array('!hudl\\.com/athlete/(?P<athlete>\\d+)/highlights/(?P<highlight>[\\da-f]+)!','!hudl\\.com/video/\\d+/(?P<athlete>\\d+)/(?P<highlight>[\\da-f]+)!'),true,array(array('extract'=>array('!hudl\\.com/(?:embed/)?athlete/(?P<athlete>\\d+)/highlights/(?P<highlight>[\\da-f]+)!'),'match'=>array('!hudl\\.com/v/!')))),
