...
class s9e_MediaBBCodes
{
	...
	*/
	...
	public static function renderTinypic($vars)
	{
		...
		$html='<div data-s9e-mediaembed="tinypic" style="display:inline-block;width:100%;max-width:560px"><div style="overflow:hidden;position:relative;padding-bottom:61.607142857143%"><object data="//tinypic.com/player.swf?file='.htmlspecialchars($vars['id'],2).'&amp;s='.htmlspecialchars($vars['s'],2).'" style="height:100%;left:0;position:absolute;width:100%" type="application/x-shockwave-flash" typemustmatch=""><param name="allowfullscreen" value="true"></object></div></div>';
