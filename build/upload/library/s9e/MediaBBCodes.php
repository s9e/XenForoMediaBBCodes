...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'gfycat'=>array('Gfycat','https://gfycat.com/',array('images'=>1),'!gfycat\\.com/(?:gifs/detail/)?(?P<id>\\w+)!',array('!gfycat\\.com/(?:gifs/detail/)?(?P<id>\\w+)!'),true,array(array('extract'=>array('!meta [^>]*?="\\w+:\\w+:height" content="(?P<height>\\d+)!','!meta [^>]*?="\\w+:\\w+:width" content="(?P<width>\\d+)!'),'match'=>array('//'),'url'=>'https://gfycat.com/ifr/{@id}')),null,array('height'=>array('s9e_MediaBBCodes::filterUint'),'width'=>array('s9e_MediaBBCodes::filterUint'))),
		...
		'googlesheets'=>array('Google Sheets','https://www.google.com/sheets/about/',array('documents'=>1),'@docs\\.google\\.com/spreadsheet(?:/ccc\\?key=|s/d/)(?!e/)(?P<id>[-\\w]+)[^#]*(?:#gid=(?P<gid>\\d+))?@',array('@docs\\.google\\.com/spreadsheet(?:/ccc\\?key=|s/d/)(?!e/)(?P<id>[-\\w]+)[^#]*(?:#gid=(?P<gid>\\d+))?@'),true),
		...
		'msnbc'=>array('MSNBC','https://www.msnbc.com/watch',array('news'=>1),"@(?P<id>)msnbc\\.com/[-\\w]+/watch/@\n@(?P<id>)on\\.msnbc\\.com/.@",array(),true,array(array('extract'=>array('@property="nv:videoId" content="(?P<id>\\w+)@','@guid"?[=:]"?(?P<id>\\w+)@'),'match'=>array('@msnbc\\.com/[-\\w]+/watch/@','@on\\.msnbc\\.com/.@'))),'<span data-s9e-mediaembed="msnbc" style="display:inline-block;width:100%;max-width:640px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:68.75%;padding-bottom:calc(56.25% + 80px)"><iframe allowfullscreen="" scrolling="no" src="//player.theplatform.com/p/7wvmTC/MSNBCEmbeddedOffSite?guid={$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></span></span>'),
