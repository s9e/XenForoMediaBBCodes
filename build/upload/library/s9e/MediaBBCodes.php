...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'imgur'=>array('Imgur','http://imgur.com/',array('images'=>1),"!imgur\\.com/(?:gallery/)?(?'id'(?:a/)?\\w+)!\n!(?'id')imgur\\.com/(?:a|gallery)/\\w!\n!(?'id')imgur\\.com/\\w+\\.(?:gifv|mp4|webm)!",array('!imgur\\.com/(?:gallery/)?(?\'id\'(?:a/)?\\w+)!'),true,array(array('extract'=>array('!<div id="(?\'type\'album)-!'),'match'=>array('!imgur\\.com/(?:a|gallery)/\\w!')),array('extract'=>array('!width:\\s*(?\'width\'\\d+)!','!height:\\s*(?\'height\'\\d+)!','!(?\'type\'gifv)!'),'match'=>array('!imgur\\.com/\\w+\\.(?:gifv|mp4|webm)!'),'url'=>'http://i.imgur.com/{@id}.gifv'))),
		...
		'soundcloud'=>array('SoundCloud','https://soundcloud.com/',array('music'=>1),"@(?'id'https?://(?:api\\.)?soundcloud\\.com/(?!pages/)\\w+/[-\\w/]+|^[^/]+/[^/]+$)@\n@(?'id')(?=.*?[./]soundcloud\\.com[:/]).*?api.soundcloud.com/playlists/(?'playlist_id'\\d+)@\n@(?'id')(?=.*?[./]soundcloud\\.com[:/]).*?api.soundcloud.com/tracks/(?'track_id'\\d+)@\n@(?'id')(?=.*?[./]soundcloud\\.com[:/]).*?/sets/@",array('@(?\'id\'https?://(?:api\\.)?soundcloud\\.com/(?!pages/)\\w+/[-\\w/]+|^[^/]+/[^/]+$)@','@(?=.*?[./]soundcloud\\.com[:/]).*?api.soundcloud.com/playlists/(?\'playlist_id\'\\d+)@','@(?=.*?[./]soundcloud\\.com[:/]).*?api.soundcloud.com/tracks/(?\'track_id\'\\d+)@'),true,array(array('extract'=>array('@api.soundcloud.com/playlists/(?\'playlist_id\'\\d+)@'),'match'=>array('@/sets/@'),'url'=>'http://api.soundcloud.com/resolve?url={@id}&_status_code_map%5B302%5D=200&_status_format=json&client_id=b45b1aa10f1ac2941910a7f0d10f8e28&app_version=7a35847b')),null,true),
