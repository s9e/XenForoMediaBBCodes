...
/**
* @copyright Copyright (c) 2013-2018 The s9e Authors
...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'bbcnews'=>array('BBC News','https://www.bbc.com/news/video_and_audio/headlines/',array('news'=>1),'!(?P<id>)bbc\\.com/news/\\w!',array(),true,array(array('extract'=>array('!bbc\\.com\\\\/news\\\\/av\\\\/embed\\\\/(?P<id>[-\\\\\\w/]+)!'),'match'=>array('!bbc\\.com/news/\\w!'))),null,array('id'=>array('stripslashes'))),
		'bleacherreport'=>array('Bleacher Report videos','https://bleacherreport.com/',array('sports'=>1),'!(?P<id>)(?=.*?[./]bleacherreport\\.com[:/]).*?/articles/.!',array(),true,array(array('extract'=>array('!id="video-(?P<id>[-\\w]+)!'),'match'=>array('!/articles/.!'))),'<span data-s9e-mediaembed="bleacherreport" style="display:inline-block;width:100%;max-width:640px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//bleacherreport.com/video_embed?id={$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></span></span>'),
		...
		'cnbc'=>array('CNBC','https://www.cnbc.com/',array('news'=>1),'!(?=.*?[./]video\\.cnbc\\.com[:/]).*?cnbc\\.com/gallery/\\?video=(?P<id>\\d+)!',array('!(?=.*?[./]video\\.cnbc\\.com[:/]).*?cnbc\\.com/gallery/\\?video=(?P<id>\\d+)!'),7=>'<span data-s9e-mediaembed="cnbc" style="display:inline-block;width:100%;max-width:400px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:95%"><object data="//plus.cnbc.com/rssvideosearch/action/player/id/{$id}/code/cnbcplayershare" style="height:100%;left:0;position:absolute;width:100%" type="application/x-shockwave-flash" typemustmatch=""><param name="allowfullscreen" value="true"/></object></span></span>'),
		...
		'gfycat'=>array('Gfycat','https://gfycat.com/',array('images'=>1),'#gfycat\\.com/(?!gaming|reactions|stickers|gifs/tag)(?:gifs/detail/|ifr(?:ame)?/)?(?P<id>\\w+)#',array('#gfycat\\.com/(?!gaming|reactions|stickers|gifs/tag)(?:gifs/detail/|ifr(?:ame)?/)?(?P<id>\\w+)#'),true,array(array('extract'=>array('!meta [^>]*?="\\w+:\\w+:height" content="(?P<height>\\d+)!','!meta [^>]*?="\\w+:\\w+:width" content="(?P<width>\\d+)!'),'match'=>array('//'),'url'=>'https://gfycat.com/ifr/{@id}')),null,array('height'=>array('s9e_MediaBBCodes::filterUint'),'width'=>array('s9e_MediaBBCodes::filterUint'))),
		...
		'googlesheets'=>array('Google Sheets','https://www.google.com/sheets/about/',array('documents'=>1),'@docs\\.google\\.com/spreadsheet(?:/ccc\\?key=|(?:[^e]/)+)(?P<id>(?:e/)?[-\\w]+)[^#]*(?:#gid=(?P<gid>\\d+))?@',array('@docs\\.google\\.com/spreadsheet(?:/ccc\\?key=|(?:[^e]/)+)(?P<id>(?:e/)?[-\\w]+)[^#]*(?:#gid=(?P<gid>\\d+))?@'),true),
		'healthguru'=>array('Healthguru','https://www.healthguru.com/',array('health'=>1),'!(?P<id>)healthguru\\.com/(?:content/)?video/.!',array(),true,array(array('extract'=>array('!healthguru\\.com/embed/(?P<id>\\w+)!'),'match'=>array('!healthguru\\.com/(?:content/)?video/.!'))),'<span data-s9e-mediaembed="healthguru" style="display:inline-block;width:100%;max-width:640px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//www.healthguru.com/embed/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></span></span>'),
		...
		'instagram'=>array('Instagram','https://instagram.com/',array('social'=>1),'!instagram\\.com/(?:p|tv)/(?P<id>[-\\w]+)!',array('!instagram\\.com/(?:p|tv)/(?P<id>[-\\w]+)!'),7=>'<iframe data-s9e-mediaembed="instagram" allowfullscreen="" onload="var a=Math.random();window.addEventListener(\'message\',function(b){if(b.data.id==a)style.height=b.data.height+\'px\'});contentWindow.postMessage(\'s9e:\'+a,\'https://s9e.github.io\')" scrolling="no" src="https://s9e.github.io/iframe/instagram.min.html#{$id}" style="border:0;height:540px;max-width:540px;width:100%"></iframe>'),
		'internetarchive'=>array('Internet Archive','https://archive.org/',array('misc'=>1),'!(?P<id>)archive\\.org/(?:details|embed)/!',array(),true,array(array('extract'=>array('!meta property="twitter:player" content="https://archive.org/embed/(?P<id>[^/"]+)!','!meta property="og:video:width" content="(?P<width>\\d+)!','!meta property="og:video:height" content="(?P<height>\\d+)!'),'match'=>array('!archive\\.org/(?:details|embed)/!'))),null,array('height'=>array('s9e_MediaBBCodes::filterUint'),'width'=>array('s9e_MediaBBCodes::filterUint'))),
		...
		'msnbc'=>array('MSNBC','https://www.msnbc.com/watch',array('news'=>1),"@(?P<id>)msnbc\\.com/[-\\w]+/watch/@\n@(?P<id>)on\\.msnbc\\.com/.@",array(),true,array(array('extract'=>array('@"video":\\{"current".*?guid":"(?P<id>\\w+)@'),'match'=>array('@msnbc\\.com/[-\\w]+/watch/@','@on\\.msnbc\\.com/.@'))),'<span data-s9e-mediaembed="msnbc" style="display:inline-block;width:100%;max-width:640px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:68.75%;padding-bottom:calc(56.25% + 80px)"><iframe allowfullscreen="" scrolling="no" src="//player.theplatform.com/p/7wvmTC/MSNBCEmbeddedOffSite?guid={$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></span></span>'),
		...
		'theguardian'=>array('The Guardian','https://www.theguardian.com/video',array('news'=>1),'!theguardian\\.com/(?P<id>\\w+/video/[-/\\w]+)!',array('!theguardian\\.com/(?P<id>\\w+/video/[-/\\w]+)!')),
		...
		'twitter'=>array('Twitter','https://twitter.com/',array('social'=>1),'@twitter\\.com/(?:#!/)?\\w+/status(?:es)?/(?P<id>\\d+)@',array('@twitter\\.com/(?:#!/)?\\w+/status(?:es)?/(?P<id>\\d+)@'),7=>'<iframe data-s9e-mediaembed="twitter" allow="autoplay *" allowfullscreen="" onload="var a=Math.random();window.addEventListener(\'message\',function(b){if(b.data.id==a)style.height=b.data.height+\'px\'});contentWindow.postMessage(\'s9e:\'+a,\'https://s9e.github.io\')" scrolling="no" src="https://s9e.github.io/iframe/twitter.min.html#{$id}" style="background:url(https://abs.twimg.com/favicons/favicon.ico) no-repeat 50% 50%;border:0;height:230px;max-width:500px;width:100%"></iframe>'),
		...
		'vocaroo'=>array('Vocaroo','https://vocaroo.com/',array('misc'=>1),'!vocaroo\\.com/i/(?P<id>\\w+)!',array('!vocaroo\\.com/i/(?P<id>\\w+)!'),7=>'<span data-s9e-mediaembed="vocaroo" style="display:inline-block;width:100%;max-width:148px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:29.72973%"><object data="//vocaroo.com/player.swf?playMediaID={$id}&amp;autoplay=0" style="height:100%;left:0;position:absolute;width:100%" type="application/x-shockwave-flash" typemustmatch=""><param name="allowfullscreen" value="true"/></object></span></span>'),
		...
		'xboxclips'=>array('XboxClips','https://xboxclips.com/',array('gaming'=>1),'@xboxclips\\.com/(?P<user>[^/]+)/(?!screenshots/)(?P<id>[-0-9a-f]+)@',array('@xboxclips\\.com/(?P<user>[^/]+)/(?!screenshots/)(?P<id>[-0-9a-f]+)@'),true),
		'xboxdvr'=>array('Xbox DVR','https://xboxdvr.com/',array('gaming'=>1),'!xboxdvr\\.com/gamer/(?P<user>[^/]+)/video/(?P<id>\\d+)!',array('!xboxdvr\\.com/gamer/(?P<user>[^/]+)/video/(?P<id>\\d+)!'),true),
