...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'comedycentral'=>array('Comedy Central','http://www.comedycentral.com/funny-videos',array('entertainment'=>1),'!(?P<id>)c(?:c|omedycentral)\\.com/(?:full-episode|video-clip)s/!',array(),true,array(array('extract'=>array('!(?P<id>mgid:arc:\\w+:[.\\w]+:[-\\w]+)!'),'match'=>array('!c(?:c|omedycentral)\\.com/(?:full-episode|video-clip)s/!')))),
		...
		'dailymotion'=>array('Dailymotion','http://www.dailymotion.com/',array('videos'=>1),'!dailymotion\\.com/(?:live/|user/[^#]+#video=|video/)(?P<id>[A-Za-z0-9]+)!',array('!dailymotion\\.com/(?:live/|user/[^#]+#video=|video/)(?P<id>[A-Za-z0-9]+)!'),7=>'<div data-s9e-mediaembed="dailymotion" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//www.dailymotion.com/embed/video/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'imgur'=>array('Imgur','http://imgur.com/',array('images'=>1),"@imgur\\.com/(?:gallery/)?(?P<id>(?:a/)?\\w+)(?!\\w|\\.(?:pn|jp)g)@\n!(?P<id>)imgur\\.com/(?:a|gallery)/\\w!\n!(?P<id>)imgur\\.com/\\w+\\.(?:gifv|mp4|webm)!",array('@imgur\\.com/(?:gallery/)?(?P<id>(?:a/)?\\w+)(?!\\w|\\.(?:pn|jp)g)@'),true,array(array('extract'=>array('!image\\s*:\\s*.*?"is_(?P<type>album)":true!','!<div id="(?P<type>album)-!','!class="(?P<type>album)-image!'),'match'=>array('!imgur\\.com/(?:a|gallery)/\\w!')),array('extract'=>array('!width:\\s*(?P<width>\\d+)!','!height:\\s*(?P<height>\\d+)!','!(?P<type>gifv)!'),'match'=>array('!imgur\\.com/\\w+\\.(?:gifv|mp4|webm)!'),'url'=>'http://i.imgur.com/{@id}.gifv'))),
		...
		'livestream'=>array('Livestream','http://new.livestream.com/',array('videos'=>1),'((?P<id>)(?=.*?[./]livestream\\.com[:/]).*?)',array('!livestream\\.com/accounts/(?P<account_id>\\d+)/events/(?P<event_id>\\d+)!','!/videos/(?P<video_id>\\d+)!'),true,array(array('extract'=>array('!accounts/(?P<account_id>\\d+)/events/(?P<event_id>\\d+)!'),'match'=>array('//')))),
		...
		'mixcloud'=>array('Mixcloud','http://www.mixcloud.com/',array('music'=>1),"@mixcloud\\.com/(?!categories|tag)(?P<id>[-\\w]+/[^/&]+)/@\n@(?P<id>)//i\\.mixcloud\\.com/\\w+$@",array('@mixcloud\\.com/(?!categories|tag)(?P<id>[-\\w]+/[^/&]+)/@'),true,array(array('extract'=>array('@link rel="canonical" href="https?://[^/]+/(?P<id>[-\\w]+/[^/&]+)/@'),'match'=>array('@//i\\.mixcloud\\.com/\\w+$@'))),'<div data-s9e-mediaembed="mixcloud" style="display:inline-block;width:100%;max-width:400px"><div style="overflow:hidden;position:relative;padding-bottom:100%"><iframe allowfullscreen="" scrolling="no" src="//www.mixcloud.com/widget/iframe/?feed=http%3A%2F%2Fwww.mixcloud.com%2F{$id}%2F&amp;embed_type=widget_standard" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'tumblr'=>array('Tumblr','https://www.tumblr.com/',array('social'=>1),"!(?P<name>[-\\w]+)\\.tumblr\\.com/post/(?P<id>\\d+)!\n!(?P<id>)\\w\\.tumblr\\.com/post/\\d!",array('!(?P<name>[-\\w]+)\\.tumblr\\.com/post/(?P<id>\\d+)!'),true,array(array('extract'=>array('!"embed_did":"(?P<did>[-\\w]+)!','!"embed_key":"(?P<key>[-\\w]+)!'),'match'=>array('!\\w\\.tumblr\\.com/post/\\d!'),'url'=>'http://{@name}.tumblr.com/post/{@id}/embed'))),
