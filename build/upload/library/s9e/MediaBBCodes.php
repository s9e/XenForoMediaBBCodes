...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		'abcnews'=>array('ABC News','http://abcnews.go.com/',array('news'=>1),'!abcnews\\.go\\.com/(?:video/embed\\?id=|[^/]+/video/[^/]+-)(?P<id>\\d+)!',array('!abcnews\\.go\\.com/(?:video/embed\\?id=|[^/]+/video/[^/]+-)(?P<id>\\d+)!'),7=>'<div data-s9e-mediaembed="abcnews" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//abcnews.go.com/video/embed?id={$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'bbcnews'=>array('BBC News','http://www.bbc.com/news/video_and_audio/',array('news'=>1),'!(?P<id>)bbc\\.com/news/\\w!',array(),true,array(array('extract'=>array('!bbc\\.com\\\\/news\\\\/(?P<id>[-\\\\\\w/]+)\\\\/embed!'),'match'=>array('!bbc\\.com/news/\\w!'))),null,array('id'=>array('stripslashes'))),
		...
		'break'=>array('Break','http://www.break.com/',array('entertainment'=>1),'!break\\.com/video/.*-(?P<id>\\d+)$!',array('!break\\.com/video/.*-(?P<id>\\d+)$!'),7=>'<div data-s9e-mediaembed="break" style="display:inline-block;width:100%;max-width:464px"><div style="overflow:hidden;position:relative;padding-bottom:60.344828%"><iframe allowfullscreen="" scrolling="no" src="//break.com/embed/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'cnnmoney'=>array('CNNMoney','http://money.cnn.com/video/',array('news'=>1),'!money\\.cnn\\.com/video/(?P<id>.*\\.cnnmoney)!',array('!money\\.cnn\\.com/video/(?P<id>.*\\.cnnmoney)!'),7=>'<div data-s9e-mediaembed="cnnmoney" style="display:inline-block;width:100%;max-width:560px"><div style="overflow:hidden;position:relative;padding-bottom:64.285714%"><iframe allowfullscreen="" scrolling="no" src="//money.cnn.com/.element/ssi/video/7.0/players/embed.player.html?videoid=video/{$id}&amp;width=560&amp;height=360" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'espn'=>array('ESPN','http://www.espn.com/',array('sports'=>1),'#(?=.*?[./]espn\\.(?>go\\.)?com[:/]).*?video/(?:clip(?:\\?id=|/_/id/))?(?P<id>\\d+)#',array('#(?=.*?[./]espn\\.(?>go\\.)?com[:/]).*?video/(?:clip(?:\\?id=|/_/id/))?(?P<id>\\d+)#'),7=>'<div data-s9e-mediaembed="espn" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//www.espn.com/core/video/iframe?id={$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		'facebook'=>array('Facebook','http://www.facebook.com/',array('social'=>1),"@/(?!(?:apps|developers|graph)\\.)[-\\w.]*facebook\\.com/(?:[/\\w]+/permalink|(?!pages/|groups/).*?)(?:/|fbid=|\\?v=)(?P<id>\\d+)(?=$|[/?&#])@\n#(?P<id>)(?=.*?[./]facebook\\.com[:/]).*?/(?P<type>video)s?/#",array('@/(?!(?:apps|developers|graph)\\.)[-\\w.]*facebook\\.com/(?:[/\\w]+/permalink|(?!pages/|groups/).*?)(?:/|fbid=|\\?v=)(?P<id>\\d+)(?=$|[/?&#])@','#(?=.*?[./]facebook\\.com[:/]).*?/(?P<type>video)s?/#'),true),
		...
		'ign'=>array('IGN','http://www.ign.com/videos/',array('gaming'=>1),'!(?P<id>https?://.*?ign\\.com/videos/.+)!i',array('!(?P<id>https?://.*?ign\\.com/videos/.+)!i'),7=>'<div data-s9e-mediaembed="ign" style="display:inline-block;width:100%;max-width:468px"><div style="overflow:hidden;position:relative;padding-bottom:56.196581%"><iframe allowfullscreen="" scrolling="no" src="//widgets.ign.com/video/embed/content.html?url={$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		'imdb'=>array('IMDb','http://www.imdb.com/',array('movies'=>1),'!imdb\\.com/[/\\w]+/vi(?P<id>\\d+)!',array('!imdb\\.com/[/\\w]+/vi(?P<id>\\d+)!'),7=>'<div data-s9e-mediaembed="imdb" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//www.imdb.com/video/imdb/vi{$id}/imdb/embed?autoplay=false&amp;width=640" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		'imgur'=>array('Imgur','http://imgur.com/',array('images'=>1),"@imgur\\.com/(?!r/|user/)(?:gallery/)?(?P<id>(?:a/)?\\w+)(?!\\w|\\.(?:pn|jp)g)@\n@(?P<id>)imgur\\.com/gallery/\\w@",array('@imgur\\.com/(?!r/|user/)(?:gallery/)?(?P<id>(?:a/)?\\w+)(?!\\w|\\.(?:pn|jp)g)@'),true,array(array('extract'=>array('!image\\s*:\\s*.*?"is_(?P<type>album)":true!','!<div id="(?P<type>album)-!','!class="(?P<type>album)-image!'),'match'=>array('@imgur\\.com/gallery/\\w@')))),
		'indiegogo'=>array('Indiegogo','http://www.indiegogo.com/',array('fundraising'=>1),'!indiegogo\\.com/projects/(?P<id>[-\\w]+)!',array('!indiegogo\\.com/projects/(?P<id>[-\\w]+)!'),7=>'<div data-s9e-mediaembed="indiegogo" style="display:inline-block;width:100%;max-width:222px"><div style="overflow:hidden;position:relative;padding-bottom:200.45045%"><iframe allowfullscreen="" scrolling="no" src="//www.indiegogo.com/project/{$id}/embedded" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'jwplatform'=>array('JW Platform','https://www.jwplayer.com/products/jwplatform/',array('videos'=>1),'!jwplatform\\.com/\\w+/(?P<id>[-\\w]+)!',array('!jwplatform\\.com/\\w+/(?P<id>[-\\w]+)!'),7=>'<div data-s9e-mediaembed="jwplatform" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//content.jwplatform.com/players/{$id}.html" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'mlb'=>array('MLB','http://mlb.com/video/',array('sports'=>1),"#mlb\\.com/[\\w/]*/v(?P<id>\\d+)#\n#mlb\\.com/r/video\\?content_id=(?P<id>\\d+)#",array('#mlb\\.com/[\\w/]*/v(?P<id>\\d+)#','#mlb\\.com/r/video\\?content_id=(?P<id>\\d+)#'),7=>'<div data-s9e-mediaembed="mlb" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//m.mlb.com/shared/video/embed/embed.html?content_id={$id}&amp;width=640&amp;height=360" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'msnbc'=>array('MSNBC','http://www.msnbc.com/watch',array('news'=>1),"@(?P<id>)msnbc\\.com/[-\\w]+/watch/@\n@(?P<id>)on\\.msnbc\\.com/.@",array(),true,array(array('extract'=>array('@guid="?(?P<id>\\w+)@'),'match'=>array('@msnbc\\.com/[-\\w]+/watch/@','@on\\.msnbc\\.com/.@'))),'<div data-s9e-mediaembed="msnbc" style="display:inline-block;width:100%;max-width:635px"><div style="overflow:hidden;position:relative;padding-bottom:69.291339%"><iframe allowfullscreen="" scrolling="no" src="//player.theplatform.com/p/2E2eJC/EmbeddedOffSite?guid={$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'nbcnews'=>array('NBC News','http://www.nbcnews.com/video/',array('news'=>1),'!nbcnews\\.com/(?:widget/video-embed/|video/[-\\w]+?-)(?P<id>\\d+)!',array('!nbcnews\\.com/(?:widget/video-embed/|video/[-\\w]+?-)(?P<id>\\d+)!'),7=>'<div data-s9e-mediaembed="nbcnews" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//www.nbcnews.com/widget/video-embed/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		'nbcsports'=>array('NBC Sports','http://www.nbcsports.com/video',array('sports'=>1),'!(?P<id>)nbcsports\\.com/video/.!',array(),true,array(array('extract'=>array('!select/media/(?P<id>\\w+)!'),'match'=>array('!nbcsports\\.com/video/.!'))),'<div data-s9e-mediaembed="nbcsports" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//vplayer.nbcsports.com/p/BxmELC/nbcsports_embed/select/media/{$id}?parentUrl=" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'nytimes'=>array('The New York Times Video','http://www.nytimes.com/video/',array('movies'=>1,'news'=>1),"!nytimes\\.com/video/[a-z]+/(?:[a-z]+/)?(?P<id>\\d+)!\n!nytimes\\.com/video/\\d+/\\d+/\\d+/[a-z]+/(?P<id>\\d+)!\n!(?P<id>)nytimes\\.com/movie(?:s/movie)?/(?P<playlist>\\d+)/[-\\w]+/trailers!",array('!nytimes\\.com/video/[a-z]+/(?:[a-z]+/)?(?P<id>\\d+)!','!nytimes\\.com/video/\\d+/\\d+/\\d+/[a-z]+/(?P<id>\\d+)!'),true,array(array('extract'=>array('!/video/movies/(?P<id>\\d+)!'),'match'=>array('!nytimes\\.com/movie(?:s/movie)?/(?P<playlist>\\d+)/[-\\w]+/trailers!'),'url'=>'http://www.nytimes.com/svc/video/api/playlist/{@playlist}?externalId=true')),'<div data-s9e-mediaembed="nytimes" style="display:inline-block;width:100%;max-width:585px"><div style="overflow:hidden;position:relative;padding-bottom:68.376068%"><iframe allowfullscreen="" scrolling="no" src="//graphics8.nytimes.com/video/players/offsite/index.html?videoId={$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		'oddshot'=>array('Oddshot','http://oddshot.tv/',array('gaming'=>1),'!(?=.*?[./]oddshot\\.tv[:/]).*?oddshot.tv/s/(?P<id>[-\\w]+)!',array('!(?=.*?[./]oddshot\\.tv[:/]).*?oddshot.tv/s/(?P<id>[-\\w]+)!'),7=>'<div data-s9e-mediaembed="oddshot" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="https://oddshot.tv/s/{$id}/embed" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'pinterest'=>array('Pinterest','https://www.pinterest.com/',array('social'=>1),"@(?=.*?[./]pinterest\\.com[:/]).*?pinterest.com/pin/(?P<id>\\d+)@\n@(?=.*?[./]pinterest\\.com[:/]).*?pinterest.com/(?!explore/|pin/)(?P<id>[-\\w]+/[-\\w]+)@",array('@(?=.*?[./]pinterest\\.com[:/]).*?pinterest.com/pin/(?P<id>\\d+)@','@(?=.*?[./]pinterest\\.com[:/]).*?pinterest.com/(?!explore/|pin/)(?P<id>[-\\w]+/[-\\w]+)@')),
		'playstv'=>array('Plays.tv','http://plays.tv/',array('gaming'=>1),"!plays\\.tv/video/(?P<id>\\w+)!\n!(?P<id>)plays\\.tv/s/!",array('!plays\\.tv/video/(?P<id>\\w+)!'),true,array(array('extract'=>array('!plays\\.tv/video/(?P<id>\\w+)!'),'match'=>array('!plays\\.tv/s/!'))),'<div data-s9e-mediaembed="playstv" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//plays.tv/embeds/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		'podbean'=>array('Podbean','http://www.podbean.com/',array('podcasts'=>1),"!podbean\\.com/media/(?:player/|share/pb-)(?P<id>[-\\w]+)!\n!(?P<id>)podbean\\.com/e/!",array('!podbean\\.com/media/(?:player/|share/pb-)(?P<id>[-\\w]+)!'),true,array(array('extract'=>array('!podbean.com/media/player/(?P<id>[-\\w]+)!'),'match'=>array('!podbean\\.com/e/!'))),'<iframe data-s9e-mediaembed="podbean" allowfullscreen="" scrolling="no" src="//www.podbean.com/media/player/{$id}" style="border:0;height:100px;max-width:900px;width:100%"></iframe>'),
		'prezi'=>array('Prezi','http://prezi.com/',array('presentations'=>1),'#//prezi\\.com/(?!(?:a(?:bout|mbassadors)|c(?:o(?:llaborate|mmunity|ntact)|reate)|exp(?:erts|lore)|ip(?:ad|hone)|jobs|l(?:ear|ogi)n|m(?:ac|obility)|pr(?:es(?:s|ent)|icing)|recommend|support|user|windows|your)/)(?P<id>\\w+)/#',array('#//prezi\\.com/(?!(?:a(?:bout|mbassadors)|c(?:o(?:llaborate|mmunity|ntact)|reate)|exp(?:erts|lore)|ip(?:ad|hone)|jobs|l(?:ear|ogi)n|m(?:ac|obility)|pr(?:es(?:s|ent)|icing)|recommend|support|user|windows|your)/)(?P<id>\\w+)/#'),7=>'<div data-s9e-mediaembed="prezi" style="display:inline-block;width:100%;max-width:550px"><div style="overflow:hidden;position:relative;padding-bottom:72.727273%"><iframe allowfullscreen="" scrolling="no" src="//prezi.com/embed/{$id}/" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		'reddit'=>array('Reddit threads and comments','http://www.reddit.com/',array('social'=>1),'!(?P<id>)(?=.*?[./]reddit\\.com[:/]).*?(?P<path>/r/\\w+/comments/\\w+/(?:\\w+/\\w+)?)!',array('!(?=.*?[./]reddit\\.com[:/]).*?(?P<path>/r/\\w+/comments/\\w+/(?:\\w+/\\w+)?)!'),true),
		...
		'slideshare'=>array('SlideShare','http://www.slideshare.net/',array('presentations'=>1),"!slideshare\\.net/[^/]+/[-\\w]+-(?P<id>\\d{6,})$!\n!(?P<id>)slideshare\\.net/[^/]+/\\w!",array('!slideshare\\.net/[^/]+/[-\\w]+-(?P<id>\\d{6,})$!'),true,array(array('extract'=>array('!"presentationId":(?P<id>\\d+)!'),'match'=>array('!slideshare\\.net/[^/]+/\\w!'))),'<div data-s9e-mediaembed="slideshare" style="display:inline-block;width:100%;max-width:427px"><div style="overflow:hidden;position:relative;padding-bottom:83.372365%"><iframe allowfullscreen="" scrolling="no" src="//www.slideshare.net/slideshow/embed_code/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		'soundcloud'=>array('SoundCloud','https://soundcloud.com/',array('music'=>1),"@(?P<id>https?://(?:api\\.)?soundcloud\\.com/(?!pages/)[-/\\w]+/[-/\\w]+|^[^/]+/[^/]+$)@i\n@(?P<id>)api\\.soundcloud\\.com/playlists/(?P<playlist_id>\\d+)@\n@(?P<id>)api\\.soundcloud\\.com/tracks/(?P<track_id>\\d+)(?:\\?secret_token=(?P<secret_token>[-\\w]+))?@\n@(?P<id>)soundcloud\\.com/(?!playlists|tracks)[-\\w]+/[-\\w]+/(?=s-)(?P<secret_token>[-\\w]+)@\n@(?P<id>)soundcloud\\.com/(?!playlists|tracks)[-\\w]+/[-\\w]+/s-@\n@(?P<id>)soundcloud\\.com/\\w+/sets/@",array('@(?P<id>https?://(?:api\\.)?soundcloud\\.com/(?!pages/)[-/\\w]+/[-/\\w]+|^[^/]+/[^/]+$)@i','@api\\.soundcloud\\.com/playlists/(?P<playlist_id>\\d+)@','@api\\.soundcloud\\.com/tracks/(?P<track_id>\\d+)(?:\\?secret_token=(?P<secret_token>[-\\w]+))?@','@soundcloud\\.com/(?!playlists|tracks)[-\\w]+/[-\\w]+/(?=s-)(?P<secret_token>[-\\w]+)@'),true,array(array('extract'=>array('@soundcloud:tracks:(?P<track_id>\\d+)@'),'match'=>array('@soundcloud\\.com/(?!playlists|tracks)[-\\w]+/[-\\w]+/s-@')),array('extract'=>array('@soundcloud://playlists:(?P<playlist_id>\\d+)@'),'match'=>array('@soundcloud\\.com/\\w+/sets/@')))),
		...
		'strawpoll'=>array('Straw Poll','http://strawpoll.me/',array('misc'=>1),'!strawpoll\\.me/(?P<id>\\d+)!',array('!strawpoll\\.me/(?P<id>\\d+)!'),7=>'<div data-s9e-mediaembed="strawpoll" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="" src="//www.strawpoll.me/embed_1/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'twitter'=>array('Twitter','https://twitter.com/',array('social'=>1),'@twitter\\.com/(?:#!/)?\\w+/status(?:es)?/(?P<id>\\d+)@',array('@twitter\\.com/(?:#!/)?\\w+/status(?:es)?/(?P<id>\\d+)@'),7=>'<iframe data-s9e-mediaembed="twitter" allowfullscreen="" onload="var a=Math.random();window.addEventListener(\'message\',function(b){if(b.data.id==a)style.height=b.data.height+\'px\'});contentWindow.postMessage(\'s9e:\'+a,\'https://s9e.github.io\')" scrolling="no" src="https://s9e.github.io/iframe/twitter.min.html#{$id}" style="background:url(https://abs.twimg.com/favicons/favicon.ico) no-repeat 50% 50%;border:0;height:186px;max-width:500px;width:100%"></iframe>'),
		...
		'vbox7'=>array('VBOX7','http://vbox7.com/',array('.bg'=>1),'!vbox7\\.com/play:(?P<id>[\\da-f]+)!',array('!vbox7\\.com/play:(?P<id>[\\da-f]+)!'),7=>'<div data-s9e-mediaembed="vbox7" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//vbox7.com/emb/external.php?vid={$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		'veoh'=>array('Veoh','http://www.veoh.com/',array('videos'=>1),'!veoh\\.com/(?:m/watch\\.php\\?v=|watch/)v(?P<id>\\w+)!',array('!veoh\\.com/(?:m/watch\\.php\\?v=|watch/)v(?P<id>\\w+)!'),7=>'<div data-s9e-mediaembed="veoh" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:62.5%;padding-bottom:calc(56.25% + 40px)"><object data="//www.veoh.com/swf/webplayer/WebPlayer.swf?version=AFrontend.5.7.0.1509&amp;permalinkId=v{$id}&amp;player=videodetailsembedded&amp;videoAutoPlay=0&amp;id=anonymous" style="height:100%;left:0;position:absolute;width:100%" type="application/x-shockwave-flash" typemustmatch=""><param name="allowfullscreen" value="true"/></object></div></div>'),
		'vevo'=>array('VEVO','http://vevo.com/',array('music'=>1),'!vevo\\.com/watch/([-/\\w]+/)?(?P<id>[A-Z0-9]+)!',array('!vevo\\.com/watch/([-/\\w]+/)?(?P<id>[A-Z0-9]+)!'),7=>'<div data-s9e-mediaembed="vevo" style="display:inline-block;width:100%;max-width:575px"><div style="overflow:hidden;position:relative;padding-bottom:56.347826%"><iframe allowfullscreen="" scrolling="no" src="//cache.vevo.com/m/html/embed.html?video={$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'videomega'=>array('Videomega','http://videomega.tv/',array('videos'=>1),'!videomega\\.tv/\\?ref=(?P<id>\\w+)!',array('!videomega\\.tv/\\?ref=(?P<id>\\w+)!'),7=>'<div data-s9e-mediaembed="videomega" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//videomega.tv/iframe.php?ref={$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		'vidme'=>array('vidme','https://vid.me',array('videos'=>1),'((?P<id>)vid\\.me/)',array(),true,array(array('extract'=>array('!meta property="og:video:type" content="video/\\w+">\\s*<meta property="og:video:height" content="(?P<height>\\d+)">\\s*<meta property="og:video:width" content="(?P<width>\\d+)!','!meta property="og:video:url" content="[^"]*vid\\.me/e/(?P<id>\\w+)!'),'match'=>array('//')))),
		...
		'vocaroo'=>array('Vocaroo','http://vocaroo.com/',array('misc'=>1),'!vocaroo\\.com/i/(?P<id>\\w+)!',array('!vocaroo\\.com/i/(?P<id>\\w+)!'),7=>'<div data-s9e-mediaembed="vocaroo" style="display:inline-block;width:100%;max-width:148px"><div style="overflow:hidden;position:relative;padding-bottom:29.72973%"><object data="//vocaroo.com/player.swf?playMediaID={$id}&amp;autoplay=0" style="height:100%;left:0;position:absolute;width:100%" type="application/x-shockwave-flash" typemustmatch=""><param name="allowfullscreen" value="true"/></object></div></div>'),
		...
		'washingtonpost'=>array('Washington Post Video','https://www.washingtonpost.com/video/',array('news'=>1),"#washingtonpost\\.com/video/c/\\w+/(?P<id>[-0-9a-f]+)#\n#washingtonpost\\.com/video/[-/\\w]+/(?P<id>[-0-9a-f]+)_video\\.html#",array('#washingtonpost\\.com/video/c/\\w+/(?P<id>[-0-9a-f]+)#','#washingtonpost\\.com/video/[-/\\w]+/(?P<id>[-0-9a-f]+)_video\\.html#'),7=>'<div data-s9e-mediaembed="washingtonpost" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//www.washingtonpost.com/video/c/embed/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		...
		'youku'=>array('Youku','http://www.youku.com/',array('.cn'=>1),'!youku\\.com/v(?:_show|ideo)/id_(?P<id>\\w+)!',array('!youku\\.com/v(?:_show|ideo)/id_(?P<id>\\w+)!'),7=>'<div data-s9e-mediaembed="youku" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:62.5%;padding-bottom:calc(56.25% + 40px)"><iframe allowfullscreen="" scrolling="no" src="https://players.youku.com/embed/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
		'youtube'=>array('YouTube','http://www.youtube.com/',array('livestreaming'=>1,'videos'=>1),"!youtube\\.com/(?:watch.*?v=|v/|attribution_link.*?v%3D)(?P<id>[-\\w]+)!\n!youtu\\.be/(?P<id>[-\\w]+)!\n!(?P<id>)(?=.*?[./]youtu(?>\\.be|be\\.com)[:/]).*?[#&?]t=(?:(?:(?P<h>\\d+)h)?(?P<m>\\d+)m(?P<s>\\d+)|(?P<t>\\d+))!\n!(?P<id>)(?=.*?[./]youtu(?>\\.be|be\\.com)[:/]).*?&list=(?P<list>[-\\w]+)!\n!(?P<id>)(?=.*?[./]youtu(?>\\.be|be\\.com)[:/]).*?/shared\\?ci=!",array('!youtube\\.com/(?:watch.*?v=|v/|attribution_link.*?v%3D)(?P<id>[-\\w]+)!','!youtu\\.be/(?P<id>[-\\w]+)!','!(?=.*?[./]youtu(?>\\.be|be\\.com)[:/]).*?[#&?]t=(?:(?:(?P<h>\\d+)h)?(?P<m>\\d+)m(?P<s>\\d+)|(?P<t>\\d+))!','!(?=.*?[./]youtu(?>\\.be|be\\.com)[:/]).*?&list=(?P<list>[-\\w]+)!'),true,array(array('extract'=>array('!/vi/(?P<id>[-\\w]+)!'),'match'=>array('!/shared\\?ci=!')))),
	...
	*/
	...
	public static function renderAmazon($vars)
	{
		...
		$html='<div data-s9e-mediaembed="amazon" style="display:inline-block;width:100%;max-width:120px"><div style="overflow:hidden;position:relative;padding-bottom:200%"><iframe allowfullscreen="" scrolling="no" style="border:0;height:100%;left:0;position:absolute;width:100%" src="//';if($vars['tld']==='es'||$vars['tld']==='it'){$html.='rcm-eu.amazon-adsystem.com/e/cm?lt1=_blank&amp;bc1=FFFFFF&amp;bg1=FFFFFF&amp;fc1=000000&amp;lc1=0000FF&amp;p=8&amp;l=as1&amp;f=ifr&amp;asins='.htmlspecialchars($vars['id'],2).'&amp;o=';if($vars['tld']==='es')$html.='30';else$html.='29';$html.='&amp;t=';if($vars['tld']==='es'&&!empty(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG_ES))$html.=htmlspecialchars(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG_ES,2);elseif($vars['tld']==='it'&&!empty(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG_IT))$html.=htmlspecialchars(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG_IT,2);else$html.='_';}else{$html.='ws-';if($vars['tld']==='jp')$html.='fe';elseif(isset($vars['tld'])&&(strpos('desfrituk',$vars['tld'])!==false))$html.='eu';else$html.='na';$html.='.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&amp;OneJS=1&amp;Operation=GetAdHtml&amp;MarketPlace=';if(isset($vars['tld']))$html.=htmlspecialchars(strtr($vars['tld'],'acdefijkprstu','ACDEFIJBPRSTG'),2);else$html.='US';$html.='&amp;ad_type=product_link&amp;tracking_id=';if($vars['tld']==='ca'&&!empty(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG_CA))$html.=htmlspecialchars(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG_CA,2);elseif($vars['tld']==='de'&&!empty(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG_DE))$html.=htmlspecialchars(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG_DE,2);elseif($vars['tld']==='fr'&&!empty(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG_FR))$html.=htmlspecialchars(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG_FR,2);elseif($vars['tld']==='jp'&&!empty(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG_JP))$html.=htmlspecialchars(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG_JP,2);elseif($vars['tld']==='uk'&&!empty(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG_UK))$html.=htmlspecialchars(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG_UK,2);elseif(!empty(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG))$html.=htmlspecialchars(XenForo_Application::get('options')->s9e_AMAZON_ASSOCIATE_TAG,2);else$html.='_';$html.='&amp;marketplace=amazon&amp;region=';if(isset($vars['tld']))$html.=htmlspecialchars(strtr($vars['tld'],'acdefijkprstu','ACDEFIJBPRSTG'),2);else$html.='US';$html.='&amp;asins='.htmlspecialchars($vars['id'],2).'&amp;show_border=true&amp;link_opens_in_new_window=true';}$html.='"></iframe></div></div>';
	...
	public static function renderBbcnews($vars)
	{
		...
		$html='<div data-s9e-mediaembed="bbcnews" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" style="border:0;height:100%;left:0;position:absolute;width:100%" src="//www.bbc.com';if((strpos($vars['playlist'],'/news/')===0)&&(strpos($vars['playlist'],'A')!==false))$html.=htmlspecialchars(strstr($vars['playlist'],'A',true),2);else$html.='/news/'.htmlspecialchars($vars['id'],2);$html.='/embed"></iframe></div></div>';
	...
	public static function renderDumpert($vars)
	{
		...
		$html='<div data-s9e-mediaembed="dumpert" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="//www.dumpert.nl/embed/'.htmlspecialchars(strtr($vars['id'],'_','/'),2).'/" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>';
	...
	public static function renderImgur($vars)
	{
		...
		$html='<iframe data-s9e-mediaembed="imgur" allowfullscreen="" onload="var b=Math.random();window.addEventListener(\'message\',function(a){a.data.id==b&amp;&amp;(style.height=a.data.height+\'px\',style.width=a.data.width+\'px\')});contentWindow.postMessage(\'s9e:\'+b,\'https://s9e.github.io\')" scrolling="no" style="border:0;height:450px;width:568px" src="https://s9e.github.io/iframe/imgur.min.html#';if($vars['type']==='album'&&!((strpos($vars['id'],'a/')===0)))$html.='a/';$html.=htmlspecialchars($vars['id'],2).'"></iframe>';
	...
	public static function renderTinypic($vars)
	{
		...
		$html='<div data-s9e-mediaembed="tinypic" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:60.9375%;padding-bottom:calc(56.25% + 30px)"><object data="//tinypic.com/player.swf?file='.htmlspecialchars($vars['id'],2).'&amp;s='.htmlspecialchars($vars['s'],2).'" style="height:100%;left:0;position:absolute;width:100%" type="application/x-shockwave-flash" typemustmatch=""><param name="allowfullscreen" value="true"></object></div></div>';
