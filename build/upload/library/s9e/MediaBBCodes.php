...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'twitch'=>array('Twitch','http://www.twitch.tv/',array('gaming'=>1),"#(?P<id>)twitch\\.tv/(?P<channel>\\w+)(?:/b/(?P<archive_id>\\d+)|/c/(?P<chapter_id>\\d+)|/v/(?P<video_id>\\d+))?#\n#(?P<id>)(?=.*?[./]twitch\\.tv[:/]).*?t=(?P<t>(?:(?:\\d+h)?\\d+m)?\\d+s)#\n#(?P<id>)clips\\.twitch\\.tv/(?P<channel>\\w+)/(?P<clip_id>\\w+)#",array('#twitch\\.tv/(?P<channel>\\w+)(?:/b/(?P<archive_id>\\d+)|/c/(?P<chapter_id>\\d+)|/v/(?P<video_id>\\d+))?#','#(?=.*?[./]twitch\\.tv[:/]).*?t=(?P<t>(?:(?:\\d+h)?\\d+m)?\\d+s)#','#clips\\.twitch\\.tv/(?P<channel>\\w+)/(?P<clip_id>\\w+)#'),true),
