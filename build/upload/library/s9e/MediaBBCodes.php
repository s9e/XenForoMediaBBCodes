...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'imgur'=>array('imgur albums and GIFV','http://imgur.com/',array('images'=>1),"!imgur\\.com/(?:a|gallery)/(?'id'\\w+)!\n!imgur\\.com/(?'id'\\w+)\\.(?:gifv|mp4)!\n!(?'id')imgur\\.com/(?:a|gallery)/\\w!\n!(?'id')imgur\\.com/\\w+\\.(?:gifv|mp4)!",array('!imgur\\.com/(?:a|gallery)/(?\'id\'\\w+)!','!imgur\\.com/(?\'id\'\\w+)\\.(?:gifv|mp4)!'),true,array(array('extract'=>array('!<div id="(?\'type\'album)-!'),'match'=>array('!imgur\\.com/(?:a|gallery)/\\w!')),array('extract'=>array('!width:\\s*(?\'width\'\\d+)!','!height:\\s*(?\'height\'\\d+)!','!(?\'type\'gifv)!'),'match'=>array('!imgur\\.com/\\w+\\.(?:gifv|mp4)!'),'url'=>'http://i.imgur.com/{@id}.gifv'))),
