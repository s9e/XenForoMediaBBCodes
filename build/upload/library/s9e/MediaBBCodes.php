...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'podbean'=>array('Podbean','http://www.podbean.com/',array('podcasts'=>1),"!podbean\\.com/media/(?:player/|share/pb-)(?P<id>[-\\w]+)!\n!(?P<id>)podbean\\.com/(?:media/shar)?e/!",array('!podbean\\.com/media/(?:player/|share/pb-)(?P<id>[-\\w]+)!'),true,array(array('extract'=>array('!podbean\\.com/media/player/(?P<id>[-\\w]+)!'),'match'=>array('!podbean\\.com/(?:media/shar)?e/!'))),'<iframe data-s9e-mediaembed="podbean" allowfullscreen="" scrolling="no" src="//www.podbean.com/media/player/{$id}" style="border:0;height:100px;max-width:900px;width:100%"></iframe>'),
		...
		'vidme'=>array('vidme','https://vid.me',array('videos'=>1),'((?P<id>)vid\\.me/)',array(),true,array(array('extract'=>array('#vid\\.me/e/(?P<id>\\w+)#','#oembed.*?url=https://vid\\.me/(?!e/)(?P<id>\\w+)#'),'match'=>array('//'))),'<span data-s9e-mediaembed="vidme" style="display:inline-block;width:100%;max-width:640px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="https://vid.me/e/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></span></span>'),
