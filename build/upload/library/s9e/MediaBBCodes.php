...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'vidme'=>array('vidme','https://vid.me',array('videos'=>1),'((?P<id>)vid\\.me/)',array(),true,array(array('extract'=>array('!vid\\.me/e/(?P<id>\\w+)!'),'match'=>array('//'))),'<div data-s9e-mediaembed="vidme" style="display:inline-block;width:100%;max-width:640px"><div style="overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="https://vid.me/e/{$id}" style="border:0;height:100%;left:0;position:absolute;width:100%"></iframe></div></div>'),
	...
	*/
	...
	public static function renderImgur($vars)
	{
		...
		$html='<iframe data-s9e-mediaembed="imgur" allowfullscreen="" onload="var b=Math.random();window.addEventListener(\'message\',function(a){a.data.id==b&amp;&amp;(style.height=a.data.height+\'px\',style.width=a.data.width+\'px\')});contentWindow.postMessage(\'s9e:\'+b,\'https://s9e.github.io\')" scrolling="no" style="border:0;height:450px;max-width:100%;width:568px" src="https://s9e.github.io/iframe/imgur.min.html#';if($vars['type']==='album'&&!((strpos($vars['id'],'a/')===0)))$html.='a/';$html.=htmlspecialchars($vars['id'],2).'"></iframe>';
