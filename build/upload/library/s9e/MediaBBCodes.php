...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'bleacherreport'=>array('Bleacher Report videos','http://bleacherreport.com/',array('sports'=>1),'!(?\'id\')(?=.*?[./]bleacherreport\\.com[:/]).*?/articles/.!',array(),true,array(array('extract'=>array('!video-(?\'id\'[-\\w]+)!'),'match'=>array('!/articles/.!'))),'<iframe width="640" height="360" src="//bleacherreport.com/video_embed?id={$id}" allowfullscreen="" frameborder="0" scrolling="no" data-s9e=""></iframe>'),
