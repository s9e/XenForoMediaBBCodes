...
class s9e_MediaBBCodes
{
	...
	*/
	public static $sites = array(
		...
		'vube'=>array('Vube','http://vube.com/',array('misc'=>1),"!vube\\.com/[^/]+/[^/]+/(?'id'\\w+)!\n!(?'id')vube\\.com/s/\\w+!",array('!vube\\.com/[^/]+/[^/]+/(?\'id\'\\w+)!'),true,array(array('extract'=>array('!vube\\.com/[^/]+/[^/]+/(?\'id\'\\w+)!'),'match'=>array('!vube\\.com/s/\\w+!'))),'<iframe width="640" height="435" src="//vube.com/embed/video/{$id}" allowfullscreen="" frameborder="0" scrolling="no" data-s9e=""></iframe>'),
