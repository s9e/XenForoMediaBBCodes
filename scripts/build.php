...
$modification->appendChild($dom->createElement(
	'replace',
	htmlspecialchars('<script>(function(){function g(a){a=a.getBoundingClientRect();var b=innerHeight+100;return-50<a.top&&a.top<b||-50<a.bottom&&a.bottom<b}function h(){d=!0}function k(){for(var a=document.getElementsByTagName("iframe"),e=a.length,f=-1;++f<e;){var c=a[f];if("about:blank"!==c.src&&!g(c)&&c.hasAttribute("allowfullscreen")){var d=/youtube\.com\/embed\/(\w+)/.exec(c.src);d&&(c.style.background="url(https://i.ytimg.com/vi/"+d[1]+"/hqdefault.jpg) no-repeat 50% 50% / cover");b.unshift([c,c.src]);c.src="about:blank"}}}var b=[],d=!0;k();b.length&&(3<b.length&&setInterval(k,6E4),addEventListener("scroll",h),addEventListener("resize",h),setInterval(function(){if(d){d=!1;for(var a=b.length;0<=--a;){var e=b[a][0],f=b[a][1];g(e)&&(e.src=f,b.splice(a,1))}}},500))})();</script>$0')
));
