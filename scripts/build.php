...
$modification->appendChild($dom->createElement(
	'replace',
	htmlspecialchars('<script>(function(){function g(a){a=a.getBoundingClientRect();var b=innerHeight+100;return-50<a.top&&a.top<b||-50<a.bottom&&a.bottom<b}function h(){d=!0}function k(){for(var a=document.getElementsByTagName("iframe"),b=a.length,d=-1;++d<b;){var c=a[d];if(!c.hasAttribute("data-lazy")&&!g(c)&&c.hasAttribute("allowfullscreen")){var f=/youtube\.com\/embed\/(\w+)/.exec(c.src);c.style.background=f?"url(https://i.ytimg.com/vi/"+f[1]+"/hqdefault.jpg) no-repeat 50% 50% / cover":"#eee";e.unshift(c);c.contentWindow.location.replace("about:blank");c.setAttribute("data-lazy","")}}}var e=[],f=!0,d=!1;k();e.length&&(3<e.length&&setInterval(k,6E4),addEventListener("scroll",h),addEventListener("resize",h),setInterval(function(){if(d)d=!1,f=!0;else if(f){f=!1;for(var a=e.length;0<=--a;){var b=e[a];g(b)&&(b.contentWindow.location.replace(b.src),b.removeAttribute("data-lazy"),e.splice(a,1))}}},100))})();</script>$0')
));
